...
public class EmployeeControllerTest {
    ...
    public void testSaveEmployee() {
        ...
        setEmployeeRequest(employee);
        employeeController.saveEmployee(employee);
        Mockito.verify(employeeService).saveEmployee(employee);
    }
    
    private void setEmployeeRequest(EmployeeRequest employee) {
    ...
    public void testDeleteEmployee() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Employee Deleted Successfully: "+employeeId, response.getBody());
